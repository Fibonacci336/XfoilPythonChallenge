...
def call(airfoil, alfas=None, output='Cp', Reynolds=0, Mach=0,  # noqa C901
    ...
    def submit(output, alfa, areMultipleAlphas=False):
        ...
        if output == "Alfa_L_0":
            ...
            if(areMultipleAlphas):
                for aoa in alfa:
                    issueCmd('ALFA %.4f' % (aoa,))
            else:
    ...
    if alfas is not None:
        ...
        if type(alfas) == list or type(alfas) == np.ndarray:
            ...
            Multiple = False
    elif (output == "Alfa_L_0" or output == "Coordinates") and alfas is None:
        Multiple = False
    elif output == "Alfa_L_0" and alfas is not None:
        raise Exception("To find alpha_L_0, alfas must not be defined")
    elif output != "Alfa_L_0" and alfas is None:
    ...
    if output == 'Coordinates':
        ...
        submit(output, alfas, areMultipleAlphas=Multiple)
